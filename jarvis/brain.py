...
class Brain:
    ...
    def _filter_tools(self, user_text: str) -> list:
        ...
        groups = {
            ...
            "health": {"health_report", "backup_now"},
        ...
        keywords = {
            ...
            "health": ["how are you", "status report", "system check", "are you ok", "are you okay", "you feeling", "health", "back yourself up", "backup", "back up your"],
