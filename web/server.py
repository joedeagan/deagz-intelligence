...
def intent(req: IntentRequest):
    ...
    system = (
        ...
        "briefing (morning report / summary of the day), music_control, none.\n"
        "play_music = ANY request to play songs/artists/albums/playlists/music (Spotify etc). "
        "music_control = pause/resume/skip/previous when it is about MUSIC or Spotify "
        "(pause/resume/stop_playback are for the TV/movies only). "
