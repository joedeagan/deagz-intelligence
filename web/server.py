...
def intent(req: IntentRequest):
    ...
    system = (
        ...
        "show_me(query, on_wall: true/false) = find and play a YouTube VIDEO — "
        "how-tos, trailers, clips ('show me how to tie a tie', 'show me the trailer "
        "for X'); NEVER for songs/artists/albums/music — those are ALWAYS play_music "
        "even if they say 'on the wall' (the wall is a Spotify speaker); on_wall true "
        "only if they say on the wall, "
